...
// RegisterRoutes TIDAK memasang RequireRole di sini - pembatasan
// owner/admin-only dilakukan lewat pemilihan route group di cmd/api/main.go
// (dashboardHandler.RegisterRoutes(adminGroup), grup yang sama dipakai
// user.Handler), sama seperti prinsip yang sudah dipegang modul lain:
// modul bisnis tidak menegakkan kebijakan otorisasi sendiri.
